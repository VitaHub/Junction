...
(function() {
  ...
  ready = function() {
    var c_options, cities, options, selected_city, selected_country, selected_state, states;
    ...
    return $('#error_explanation h2').addClass('h4');
  };
...
(function() {
  ...
  ready = function() {
    return $("#messages-list").scrollTop($('#messages-list table').height());
  };
...
(function() {
  ...
  ready = function() {
    ...
    $('#additional-menu').click(function() {
      ...
      return $('.additional-options').slideToggle();
    });
    cities = $('#city_id').html();
    ...
    return $('#state_id').change(function() {
      var state;
      state = $('#state_id :selected').text();
      options = $(cities).filter("optgroup[label='" + state + "']").html();
      if (options) {
        $('#city_id').html('<option value=""></option>' + options);
        return $('#city_id').parent().fadeIn();
      } else {
        $('#city_id').empty();
        return $('#city_id').parent().fadeOut();
      }
